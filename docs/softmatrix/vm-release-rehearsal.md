...
| OIDC success with local RS256/JWKS/PKCE fixture | `[x]` CI | [Ubuntu VM Smoke](https://github.com/yonglun/softmatrix-os/actions/runs/31367656028/job/93389453548); production IdP still pending |
| OIDC cancellation and domain-denial mapping with local fixture | `[x]` CI | [Ubuntu VM Smoke](https://github.com/yonglun/softmatrix-os/actions/runs/31367656028/job/93389453548); production IdP replay still pending |
