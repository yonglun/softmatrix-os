...
export default function SidebarGadgetRow({
  ...
  return (
    <Link
      ...
      title={collapsed ? gadget.title || t('shell.untitledWorkspace') : undefined}
    >
      <div
      ...
      {!collapsed && (
        <>
          {renaming ? (
            ...
            <span className="min-w-0 flex-1 truncate">{gadget.title || t('shell.untitledWorkspace')}</span>
          )}
            ...
            <DropdownMenu>
              ...
              <DropdownMenu.Content className={MENU_CONTENT} style={MENU_POSITIONER_STYLE}>
                <DropdownMenu.Item
                  ...
                  className={MENU_ITEM}
                >
                  <Pencil size={13} className="mr-2" /> {t('shell.rename')}
                </DropdownMenu.Item>
                <DropdownMenu.Item
                ...
                >
                  ...
                  {gadget.pinned ? t('shell.unfavorite') : t('shell.favorite')}
                </DropdownMenu.Item>
                <DropdownMenu.Item
                  onClick={() => onShare(gadget)}
                  className={MENU_ITEM}
                >
                  <ShareNetwork size={13} className="mr-2" /> {t('shell.share')}
                </DropdownMenu.Item>
                ...
                >
                  ...
                  {gadget.owner ? t('shell.dismiss') : t('shell.delete')}
                </DropdownMenu.Item>
      ...
      {collapsed && <span className="sr-only">{gadget.title || t('shell.untitledWorkspace')}</span>}
    </Link>
  )
}
