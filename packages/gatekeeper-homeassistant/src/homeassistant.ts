...
<body>
  <div class="card">
    ...
    <p>Provide the URL of your Home Assistant instance and a long-lived access token. ${PRODUCT_NAME} will use these to read entity states and control devices.</p>
    ...
    <form method="POST" action="${escapeAttr(params.actionUrl)}">
      ...
      <details>
        ...
        <ol>
          ...
          <li>Give it a name like "${PRODUCT_NAME}", then copy the token and paste it above.</li>
        </ol>
      </details>
...
<body style="font-family: system-ui, sans-serif; padding: 2rem; text-align: center;">
  ...
  <p>Home Assistant has been linked to ${PRODUCT_NAME}. You may close this tab.</p>
</body>
</html>`;
...
<body style="font-family: system-ui, sans-serif; padding: 2rem; text-align: center;">
  ...
  <p>This connection link is invalid or has expired. Please return to ${PRODUCT_NAME} and start over.</p>
</body>
</html>`;
...
export class GatekeeperVendor extends WorkerEntrypoint<Env> implements GatekeeperVendorIface {
  async describe(): Promise<VendorDescription> {
    return {
      ...
      description:
          `Connect your Home Assistant instance so ${PRODUCT_NAME} can read entity state, call services ` +
